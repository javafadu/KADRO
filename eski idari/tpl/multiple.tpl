...
function checkform() {
	...
	if (IsEmptyField(document.form2.field_name)){alert ("Your 'Field Name' can not be left blank. Please check again");document.form2.field_name.select();document.form2.field_name.focus();return false;}   
