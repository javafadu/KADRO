...
<td>
<input type="Text" name="to" id="to" class="fields" size="35" onFocus="source_id = 'to'" value="<#to#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)"></td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_cc#></strong></td>
<td>
<input type="Text" name="cc" id="cc" class="fields"  size="35" onFocus="source_id = 'cc'" value="<#cc#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)">
</td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_bcc#></strong></td>
<td>
<input type="Text" name="bcc" id="bcc" class="fields" size="35" onFocus="source_id = 'bcc'" value="<#bcc#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)"></td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_from#></strong></td>
<td>
<input type="Text" name="from" id="from" class="fields" size="35" onFocus="source_id = 'from'" value="<#from#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)"></td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_subject#></strong></td>
<td>
<input type="Text" name="subject" id="subject" class="fields" onFocus="source_id = 'subject'" value="<#subject#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)"></td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_attachments#></strong></td>
<td>
<input type="Text" name="attach" id="attach" class="fields" size="35" onFocus="source_id = 'attach'" value="<#attach#>" onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)"></td>
</tr>
<tr>
<td align="right" nowrap valign="top"><strong><#msg_body#></strong></td>
<td>
<textarea onselect="storeCaret(this)" onclick="storeCaret(this)" onkeyup="storeCaret(this)" name="body" id="body" rows="15" cols="50" wrap="virtual" onFocus="source_id = 'body'"><#body#></textarea>	</td>
</tr>
...
<tr bgcolor="#ffffff">
<td><a class="nlink2"  onclick = "InsertName('%HTTP_REFERER',0);">HTTP Referer</a></td>
<td>Referered page</a></td>
</tr>
...
<!-- ~~~ [submiters >>>] ~~~ --><tr>
<td align="center" class="color2"><input name="Submit" type="submit" class="buttons" value="<#msg_submit#>"> <input name="<#msg_cancel#>" type="button" class="buttons" value="<#msg_cancel#>" onclick="document.location = 'formedit.php?form=<#formid#>';"> <input name="Reset" type="reset" class="button" value="<#msg_reset#>"></td>
</tr><!-- ~~~ [<<< submiters] ~~~ -->
</table></td>
</tr>
</tr>
