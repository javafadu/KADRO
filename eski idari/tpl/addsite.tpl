...
<td>
<input name="sitename" value="<#sitename#>" type="text" id="name" class="fields" size="35" onBlur="copyURL();" >
</td>
</tr>

<tr>
<td align="right" nowrap><strong><#msg_site_reffs#></strong> <span class="tlabel">*</span></td>
<td><input name="siterefs" type="text" value="<#siterefs#>" id="refs" class="fields" size="35"></td>
</tr>
</table>
</td>
<td class="color5" width="1"><img src="images/1x1.gif" width="1" height="1"></td>
