...
<br>				
				...
				<!-- BEGIN calc_row -->
					<tr<#class#>>
						...
						<td nowrap><a href="draw.php?do=edit&id=<#calc_id#>&field=8&page=<#pageid#>"><img src="images/icon-action-edit.gif" alt="edit" width="13" height="13" hspace="3" border="0"></a> <a href="coder.php?do=delcalc&id=<#calc_id#>&page=<#pageid#>" title="delete"><img src="images/icon-action-delete.gif" alt="delete" width="13" height="13" hspace="3" border="0"></a></td>
					</tr>
				<!-- END calc_row -->
				</tbody>
				</table>
