...
if(isset ($sqldelete))
{
echo "<br><center><font face=Verdana size=2 color=brown>Kayit Bilgileriniz Veritananindan Silinmistir.<br> ......</font><br><br> <a href='personelofise.php?ofis=$ofis'>$ofis SAYFASINA GERI DÖN</a>";
}
else
{
