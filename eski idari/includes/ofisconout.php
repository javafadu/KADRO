...
<?php
$queryofis = "SELECT sehir_kod FROM ofislist where ofisulke1 not like 'TURKEY' ORDER BY sehir_kod ASC ";
...
echo "<OPTION value=\"personelofise.php?ofis=$sehir_kod\">$sehir_kod</OPTION>";
}
?>
