...
$count17 = mysql_query("select COUNT(*) from kadro where baskan like '%pazarlama%' and sicil<>0  ");
$sayi17 = mysql_fetch_assoc($count17);

$count18 = mysql_query("select COUNT(*) from kadro where baskan like '%Gelir%' and sicil<>0  ");
$sayi18 = mysql_fetch_assoc($count18);

$count19 = mysql_query("select COUNT(*) from kadro where baskan like '%plan%' and sicil<>0  ");
$sayi19 = mysql_fetch_assoc($count19);

$count20 = mysql_query("select COUNT(*) from kadro where baskan like '%tirme%' and sicil<>0  ");
$sayi20 = mysql_fetch_assoc($count20);

$count21 = mysql_query("select COUNT(*) from kadro where baskan like '%kargo%' and sicil<>0  ");
$sayi21 = mysql_fetch_assoc($count21);

$count22 = mysql_query("select COUNT(*) from kadro where baskan like '%dari%' and sicil<>0  ");
$sayi22 = mysql_fetch_assoc($count22);

$count23 = mysql_query("select COUNT(*) from kadro where ofis like '%Tic%'  and sicil<>0  ");
...
<table width="82%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8" bgcolor="fffffe">
            <tr>
              ...
              <td width="13%" bordercolor="#80B0D8" bgcolor="#80B0D8">&nbsp;</td>
            ...
            <tr>
              ...
              <td bordercolor="#80B0D8" bgcolor="#80B0D8">&nbsp;</td>
 ...
 <br />
<table width="41%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8" bgcolor="fffffe">
  <tr>
