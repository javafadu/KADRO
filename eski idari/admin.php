...
<form name="form1" method="post" action="">
  <p class="smallTextBlack"><?php echo $msg; ?><br>USER LEVELS:<BR>
    1 = ACCESS LEVEL 1 ONLY<BR>
    2 =  ACCESS BOTH LEVELS 2 & 1<BR>
    3 = ACCESS BOTH LEVELS 3, 2 & 1<BR>
    4 = ADMIN AND ALL LEVELS</p>
  <table width="100%" border="0" cellpadding="1" cellspacing="1" bordercolor="#000000">
    <tr bgcolor="#A39FF6" class="standardText"> 
      ...
      <td><div align="center"><a class="standardText" href="admin.php?order=userid">ID</a></div></td>
      <td><div align="center"><a class="standardText" href="admin.php?order=user_name">KULLANICI ADI</a> </div></td>
      <td><div align="center">SIFRE </div></td>
      <td><div align="center"><a class="standardText" href="admin.php?order=user_level">SEVIYE</a></div></td>
      <td><div align="center"><a class="standardText" href="admin.php?order=user_email">E-MAIL</a></div></td>
      <td><div align="center">IP ADRES </div></td>
      <td><div align="center"><a class="standardText" href="admin.php?order=date">KAYIT TARIHI</a> </div></td>
    </tr>
