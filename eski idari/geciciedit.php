...
<form name="form1" method="post" action="gecicigir2edit.php?id=<? echo "$liste4[id]"; ?>">
  <table width="60%" border="0" align="center" cellspacing="2" bgcolor="#EFEFEF">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="38%"><label>
	   <input name="ofis" type="text" id="ofis" value="<? echo "$liste4[ofis]"; ?>" size="10"> 
      </label></td>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td colspan="2"><label>
        <select name="bolge" id="bolge">
          ...
          <option value="M&uuml;&#351;teri &#304;li&#351;kileri">M&uuml;&#351;teri &#304;li&#351;kileri</option> <option value="Antalya Kargo">Antalya Kargo</option>
...
?>
    ...
    <tr bgcolor="#FFFFCC">
      <td class="data style1 style3">STATUS</td>
      <td><label>
      ...
      <td valign="middle" class="comment style2 style1">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFCC">
