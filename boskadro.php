...
echo "<table width='60%' bgcolor='EFEFEF' align='center' border='1' bordercolor='#CCCCCC'><tr bgcolor='#CDCDCD'>";
echo"<tr>
...
$sql = mysql_query("select * from kadro  where sicil = '0' order by ofis,unvan ASC ");
