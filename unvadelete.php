...
$sec = mysql_query("select * from yerler where id='$id' ");
...
$deg=mysql_query("INSERT INTO degisiklikler (id,tarih,saat,kisi,baskan,konu,konu2,ofis) VALUES (NULL, '$tarih', '$saat', '$kisi','$baskan','Yer Bilgisi Silindi', '$yer',  '$id')  ");

		
$sql=mysql_query("DELETE FROM yerler where id='$id'");
