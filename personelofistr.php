...
echo "<td align='center' width='33%' bgcolor='#FFFFD9'><font color='red'><b></b></font>  "; 
...
if($ofis <> '%kargo')
{
echo "<font color='red'><b>$sehir</b></font><br>"; 
}
else
{
echo"<br>";
...
if($listeofis[bag]<>'a')
{
echo"Bagli Bulundugu Müdürlük <a href='personelofistr.php?ofis=$bagi'><b>$bagi</b></a><br>";
}
else
{
}
...
{
echo"<a href='personelofistr.php?ofis=$listebagli[sehir_kod]'><b>$listebagli[sehir_kod]</b></a> - ";
}
}
else
{
...
<table width='95%' bgcolor='EFEFEF' align='center' border='1' bordercolor='#CCCCCC'><tr bgcolor='#CDCDCD'>
<?
...
?>"><? echo "$liste[durum]"; ?>
	...
	?>
	 ...
	 <td valig="top" bgcolor="<? echo"$dd"; ?>"> <? echo "$liste[sozbit]"; ?></td>
...
?>"><? echo "$listepart[durum]"; ?>
	 ...
	 <td valig="top"><? echo "$listepart[sozbas]"; ?></td>
	 
	  <?
	if($listepart[sozbit]<=$tarih and $listepart[sozbit]<>0)
	{
	$cd="#FFC1C1";
	...
	?>
	 ...
	 <td valig="top" bgcolor="<? echo"$cd"; ?>">
	 
	 <? echo "$listepart[sozbit]"; ?>
	 </td>
