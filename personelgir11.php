...
<form name="form1" method="post" action="personelgir2.php">
 
  <table border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFC">
    <tr bgcolor="#EFEFEF">
      <td width="109" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="comment style12 style21"><span class="style16"><strong>KADRO B&#304;LG&#304;LER&#304; </strong></span></td>
      ...
      <td width="204" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="style16">&nbsp;</td>
    ...
    <tr bgcolor="#EFEFEF">
      ...
      <td bordercolor="f4f4f4" bgcolor="#FFEAEA" class="comment style1 style2"><input name="sicil" type="text" id="sicil"> 
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4" class="style16"><span class="style16">
        <?
		
		$ss=mysql_query("select * from kadro where id='$secim' ");
		while($ssliste=mysql_fetch_array($ss))
		{
		echo"<font color='brown'><b>$ssliste[ofis]</b></font>";
		
		
		?>
		
        <input name="ofis" type="hidden" id="ofis" value="<? echo"$ssliste[ofis]"; ?>">
      </span></td>
    ...
    <tr bgcolor="#EFEFEF">
      ...
      <td bordercolor="f4f4f4"><span class="style15">
        <input name="isim" type="text" id="isim" />
      </span></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="f4f4f4" bgcolor="f4f4f4" class="data style12 style21 style16">&Uuml;nvan&#305;</td>
      <td bordercolor="f4f4f4" bgcolor="f4f4f4" class="style16"><span class="style15">
        <label>        </label>
      </span>
        <label>
        <?
		echo "<b><font color='brown'>$ssliste[unvan]</font></b>";
        

?>
        </label>        <input name="unvan" type="hidden" id="unvan" value="<? echo "$ssliste[unvan]"; ?>">
        <input name="kid" type="hidden" id="kid" value="<? echo "$ssliste[id]"; ?>"></td>
      <td bordercolor="#FFFFFF" bgcolor="#FFFFFC">&nbsp;</td>
    </tr>
    <tr bgcolor="#EFEFEF">
      <td bordercolor="f4f4f4"><span class="data style12 style21 style16">Tahsili</span></td>
      <td bordercolor="f4f4f4"><input name="tahsil" type="text" id="tahsil" /></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4"><span class="style15">
        <label></label>
        <label>
        <input name="kadro" type="text" id="kadro" value="<? echo "$ssliste[kadro]"; ?>">
        </label>
        </span>
          <?
    ...
    <tr bgcolor="#EFEFEF">
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4"><span class="style15">
        <label>
        <input name="bastarihi" type="text" id="bastarihi" />
        </label>
      </span></td>
      <td bordercolor="#FFFFFF" bgcolor="#FFFFFC">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4"><span class="style15">
        <label>
        <textarea name="hareket" rows="3" id="hareket"></textarea>
        </label>
      </span></td>
...
?></td>
    ...
    <tr>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4" class="comment style10 style12 style14"><span class="comment style2 style1"><span class="style16">
        <input name="kidemucret" type="text" id="kidemucret" />
      </span></span></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
    ...
    <tr>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4" class="comment style10 style12 style14"><span class="comment style2 style1"><span class="style15">
        <input name="netucret" type="text" id="netucret" />
      </span></span></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
    ...
    <tr>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4"><span class="style15">
        <label>
        <input name="sozbas" type="text" id="sozbas">
        <br>
    ...
    <tr>
      ...
      <td bordercolor="f4f4f4" bgcolor="f4f4f4"><span class="style15">
        <input name="sozbit" type="text" id="sozbit">
        <br>
    ...
    <tr>
      ...
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><label>
        <input name="tckimlik" type="text" id="tckimlik">
      </label></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      ...
      <td rowspan="2" bordercolor="ffffff" bgcolor="#F4F4F4"><label>
        <textarea name="adres" rows="3" id="adres"></textarea>
      </label></td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><input name="sskno" type="text" id="sskno"></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="data style12 style21 style16">Ev Telefonu </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4"><input name="evtel" type="text" id="evtel"></td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td bordercolor="ffffff" bgcolor="#F4F4F4"><input name="ceptel" type="text" id="ceptel"></td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    </tr>
    <tr>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style12 style20 style16">Anne Ad&#305; </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><input name="anne" type="text" id="anne"></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="data style12 style21 style16">&#304;&#351; Telefonu </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4"><input name="istel" type="text" id="istel"></td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    </tr>
    <tr>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style12 style20 style16">Baba Ad&#305; </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><input name="baba" type="text" id="baba"></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="data style12 style21 style16">E-Mail Adresi </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4"><input name="email" type="text" id="email"></td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    </tr>
    <tr>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style12 style20 style16">Do&#287;um Tarihi </td>
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><input name="dogtar" type="text" id="dogtar"></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style12 style21 style16">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="ffffff">&nbsp;</td>
      <td bordercolor="#FFFFFF" class="comment">&nbsp;</td>
    ...
    <tr>
      ...
      <td bordercolor="ffffff" bgcolor="#F4F4F4" class="comment style10 style12 style14"><input name="dogyer" type="text" id="dogyer"></td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style10 style12 style14">&nbsp;</td>
      <td bordercolor="ffffff" bgcolor="ffffff" class="data style12 style21 style16">&nbsp;</td>
