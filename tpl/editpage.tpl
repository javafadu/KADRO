...
<td>
<input name="pagename" value="<#pagename#>" id="pagename" type="text" class="fields" size="35"<#onblur#>>
</td>
</tr>
<tr>
<td align="right" nowrap><strong><#msg_page_url#></strong> <span class="tlabel">*</span></td>
<td>
<input name="pageurl" value="<#pageurl#>" id="pageurl" type="text" class="fields" size="35"<#disabled#>>
</td>
</tr>
