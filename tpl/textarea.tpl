...
<td class="color2" style="padding:0 8px"><span class="tlabel"><#msg_textar_field_adding#> "<#pagename#>"</span></td>
...
<tr>
	...
	<input type="checkbox" value="1"  name="req"<#freq#>><font face="Verdana" size="2"><#msg_fld_req#></td>
  </tr>
<tr><td>&nbsp;</td> 
<td>
...
if (document.form1.field_name.value==''){alert ("Your 'Field Name' can not be left blank. Please check again");document.form1.field_name.select();document.form1.field_name.focus();return false;}   
else {	return true;}
}
