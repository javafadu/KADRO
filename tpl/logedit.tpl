...
<tr>
<td align="center" class="color2"><input name="Submit" type="submit" class="buttons" value="<#msg_submit#>" onclick="document.form1.submit();"> <input name="Cancel" type="button" class="button" value="<#msg_cancel#>" onclick="document.location = 'browse.php?id=<#log#>&form=<#form_id#>';"></td>
</tr>
