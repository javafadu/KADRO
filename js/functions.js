...
var text  = '1) Click the "Add new page" button and follow the wizard instructions to generate html page for your form.When html code is generated you will be redirected back to this panel.<br><BR>';
    ...
    text += '4) Your form will also require error template - the page that will be shown if for example user left some of required fields in the form blank. The error template is generated automatically by Form Builder Pro, however if you are familiar with HTML you can edit it to look and feel more like the rest of your site.<br><br>';
