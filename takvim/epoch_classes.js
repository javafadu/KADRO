...
{
	this.daylist = new Array('Pz','Pts','Sal','Car','Prs','Fr','Cts','Pz','Pts','Sal','Car','Prs','Cum','Cts'); /*<lang:en>*/
	this.months_sh = new Array('Ock','Sbt','Mrt','Nsn','May','Haz','Tem','Aug','Eyl','Ekm','Ksm','Arl');
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Ocak','Subat','Mart','Nisan','Mayis','Haziran','Temmuz','Agustos','Eylül','Ekim','Kasim','Aralik','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
	var DAY_NAMES = new Array('Pazar','Pazartesi','Sali','Çarsamba','Persembe','Cuma','Cumartesi','Pz','Pst','Sal','Car','Per','Cum','Cts');
	format = format + "";
	var result="";
	var i_format=0;
	var c="";
